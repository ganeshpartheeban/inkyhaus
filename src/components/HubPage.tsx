    ...
    <Reveal delay={i * 40}>
      <TiltCard max={6}>
        <Link
          ...
          className="group block overflow-hidden rounded-[var(--radius-card)] border border-line bg-surface active:scale-[0.985]"
        >
  ...
  return (
    <>
      ...
      <Section className="!pt-8">
        <SectionHeading as="h1" eyebrow={h.tagline[l]} title={h.title[l]} subtitle={h.intro[l]} />
